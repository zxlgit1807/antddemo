...
export default class MyGallerys extends React.Component{
    state={
        visible:false
    }
    ...
    render() {
        ...
        const imgList = imgs.map((list) => list.map((item)=> 
            <Card style={{marginBottom:10}} cover={<img src={'/gallery/'+item} onClick={()=>this.openGallery(item)}/>}>
                <Card.Meta title="你好" description="世界"/>
            </Card>
        ))
        ...
        return(
            ...
            <div>
                ...
                <Modal title="图片" width={300} height={500} visible={this.state.visible} onCancel={()=>{
                    this.setState({
                        visible : false
                    })
                }} footer={null}>
